...
class OrderItem(Base):
    ...
    # Snapshot of the frame's slot_positions/text_positions/frame_asset_url at
    # the moment this order was placed. Print generation must read from this,
    # not the live Frame row, so a later admin edit to the frame's layout
    # cannot reflow or drop photos on an already-paid order.
    frame_snapshot: Mapped[dict | None] = mapped_column(json_type, nullable=True)
