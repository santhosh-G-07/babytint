...
SQLITE_COMPAT_COLUMNS: dict[str, list[str]] = {
    "users": [
        ...
        "ALTER TABLE users ADD COLUMN password_reset_failed_attempts INTEGER NOT NULL DEFAULT 0",
        "ALTER TABLE users ADD COLUMN password_reset_locked_until DATETIME",
    ],
    "orders": [
    ...
    "order_items": [
        ...
        "ALTER TABLE order_items ADD COLUMN frame_snapshot JSON",
    ],
    "frames": [
